...
export const headCount = async () => {
    ...
    try {
        const numberOfStudents = await Student.aggregate([
            {
                $count: "totalStudents" // Counts all documents in the Student collection
            }
        ]);
...
export const grade = async (studentId) => Student.aggregate([
    ...
    {
        $group: {
            _id: '$_id', // Groups by student _id
            overallGrade: { $avg: '$assignments.score' } // Calculates average score
        }
    },
]);
/**
